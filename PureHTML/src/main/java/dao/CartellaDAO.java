...
public class CartellaDAO {
	...
	//Cerca nel db una cartella tramite il suo id e la ritorna
	...
	//Cerca nel db le sottocartelle (figli diretti) di una cartella padre e li ritorna
	...
	//Controlla se una cartella con un certo nome è già presente nel db di un certo utente e la ritorna se trovata
	...
	//Crea una cartella di primo livello nel db e ritorna un intero per successo/insuccesso
	...
	//Crea una sottocartella nel db e ritorna un intero per successo/insuccesso
	...
	//e salvandole in una struttura ad albero tramite la lista 'sottocartelle' del bean Cartella
